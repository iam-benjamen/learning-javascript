...
console.log(0.1 + 0.2); //return 0.300000004
...
console.log(Number.isNaN(23 / 0)); //retunrs Infinity
...
//To do somrthing every nth time, use remainder
// Numbers are represented in 64 bits, onlt 53 is safely used

console.log(Number.MAX_SAFE_INTEGER); // The safest Biggest Integer JavScript can take
console.log(2 ** 53 - 1);

//Big int
console.log(3485789342758947289743892739475894n); //the n transforms the number into a biginit
...
//Amount of seconds since beginning of unix time, 1970
